...
def main():
    ...
    while True:
        ...
        try:
            ...
            # Exit alert — 2:00 PM on expiry, 3:20 PM on normal day
            exit_time = dtime(14, 30) if is_expiry_day else dtime(15, 20)
            exit_time_end = dtime(14, 34) if is_expiry_day else dtime(15, 24)
