...
def format_message(results, buildups, top_chg, ping, resp,
    ...
    lines.append(f"📡 *OC RADAR v10* · {now_ist}")
    ...
    lines.append("_OC Radar v10 · Educational only_")
    return "\n".join(lines)
...
def send_market_open_alert(expiries, global_data):
    ...
    msg   = (
        ...
        "_OC Radar v10 · Educational only_"
    )
    send_telegram(msg)
    ...
    for a in alerts:
        if a["type"] == "PARTIAL":
            msg = (
                ...
                f"━━━━━━━━━━━━━━━━━━━━━━\n"
                f"_OC Radar v10 · Educational only_"
            )
        elif a["type"] == "TARGET":
            msg = (
